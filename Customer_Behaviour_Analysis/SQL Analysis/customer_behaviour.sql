...
--Q5. Do subscribed customers spend more? Compare average spending and total revenue between subscribers and non-subscribers.
...
select customer_segment, count(*) as no_of_customers from customer_loyalty_type
...
select  category, item_purchased,item_rank, total_orders from item_counts
where item_rank <=3
